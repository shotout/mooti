...
return [
    'content' => '
        <div class="col-lg-12">
            <h6>Last updated : November 8th 2022</h6>

            <h4 class="mt-4">Mooti Privacy Policy</h4>
            <h4>I. Name and address of the data controller</h4>
            <p>
            ...
            <h4 class="mt-4">Privacy Policy of the Website</h4>
            <h4>I. Provision of the website</h4>
            ...
            <h4 class="mt-4">II. Use of website cookies</h4>
            <ol>
                <li>
                    Description and scope of data processing
                    <p>
                    ...
                    <ol>
                        <li>The user’s IP address</li>
                        <li>Website accessed</li>
                        <li>The website from which the user has accessed our website (referrer)</li>
                        <li>Subpages that are accessed from the accessed website</li>
                        <li>Time and duration of access</li>
                        <li>The frequency with which our website is accessed</li>
                        <li>Location of the user (localization of the IP address)</li>
                        <li>Users browser</li>
                        <li>Information about the end device (operating system and version, device brand and device model)</li>
                        <li>
                            <p>User events</p>
                        </li>
                    </ol>
                ...
                <li>
                    Duration of storage and options for objection and removal
                    <p>
            ...
            <ol>
                <li>
                    ...
                    <ol>
                        <li>Email address</li>
                        <li>Optional: first name and surname</li>
                        <li>The users IP address</li>
                        <li><p>Time of registration</p></li>
                    </ol>
                    <p>
            ...
            <h4 class="mt-4">V. Email contact</h4>
            <ol>
                <li>
                    Description and scope of data processing
                    <p>
                    ...
                    <ul>
                        <li>Email address</li>
                        <li>Content of the email message</li>
                        <li>If applicable, surname, first name of the user (depending on the information in the email)</li>
                        <li><p>If applicable, information from the email signature such as contact details</p></li>
                    </ul>
                    <p>
            ...
            <h4 class="mt-4">VI. Web analysis by Google Analytics</h4>
            <ol>
                <li>
                    Description and scope of data processing
                    <p>
                ...
                <li>
                    Duration of storage, possibilities for objection and data deletion
                    <p>
            ...
            <h4 class="mt-4">Privacy Policy of the App</h4>
            <h4>I. Provision of the app</h4>
            <ol>
                <li>
                    Description and scope of data processing
                    <p>
                    ...
                    <ol>
                        <li>The user’s IP address</li>
                        <li>Information about the end device (operating system and version, device brand and device model, Android Advertising ID, Apple IDFA / IDFV, language setting)</li>
                        <li>Location of the user (localization of the IP address)</li>
                        <li>Optional: GPS coordinates of the user</li>
                        <li>Time and duration of access</li>
                        <li>Information on used crypto-wallets</li>
                        <li>User events (e.g. favoring a Quote)</li>
                        <li><p>Device tokens, e.g. for sending push notifications</p></li>
                    </ol>
                </li>
                <li>
                    Legal basis for data processing
            ...
            <h4 class="mt-4">II. Account registration</h4>
            <ol>
                <li>
                    Description and scope of data processing
                    <p>
                    ...
                    <ol>
                        ...
                        <li>Answers to several questions that are asked to personalize the app & content shown</li>
                    </ol>
                    <p>
                ...
                <li>
                    Possibility of objection and deletion
                    <p>
                        As a user, you have the option of canceling the registration at any time. You may at any time change the data we have stored about you. The account can be deleted at any time via the settings in the Mooti app.
                    </p>
                </li>
            </ol>

            <h4 class="mt-4">III. Disclosure of personal data to third parties</h4>
            <ol>
                <li>
                    Description and scope of data processing
                    <p>
                ...
                <li>
                    Third party and social services
                    <p>
            ...
            <h4 class="mt-4">IV. Transfer to third countries</h4>
            <ol>
                <li>
                    Description and scope of data processing
                    <p>
                        In order to provide the services related to Mooti, data is also transmitted to third countries. If processing by third party services takes place outside the European Union or the European Economic Area, these must meet the special requirements of Art. 44 et seq. GDPR.
                    </p>
                </li>
                <li>
                    Legal basis for data processing
            ...
            <p>
                Mooti works together with service providers to offer services related to Mooti. A service provider receives personal data from Mooti and is commissioned to process this data for certain purposes. Below is a list of all Mooti service providers with the purpose and location of the data processing. Further details on data processing can be found in the respective privacy notices of the service providers. For more information contact contact@mooti.app. We would like to point out that these service providers are based in the USA, i.e. outside the EU. As the ECJ has established, there is currently no level of data protection in the USA comparable to that in the EU, as US authorities and secret services could access this data. If we obtain your consent when you access the app, you consent to the transmission of the data and any access by these authorities.
            </p>
            <table class="table table-bordered table-responsive-md">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Newsletter Provider (Mailchimp)</td>
                    ...
                    <tr>
                        ...
                        <td>Delivery of automated, transactional E-Mails</td>
            ...
            <p>
                ...
                We hereby declare that we do not sell your personal information to a third party in exchange for monetary or other benefits or value; additionally to the general user’s rights listed above you have:
            </p>
            <ul>
                <li>
            ...
            <p>
                If your personal data is processed, you are a data subject within the meaning of the GDPR and you have the following rights vis-à-vis the controller. You can assert these rights by sending an email to contact@mooti.app:
            </p>
            <ol>
                <li>
                    ...
                    <ol>
                        <li>the purposes for the processing of personal data</li>
                        <li>the categories of personal data being processed</li>
                        <li>the recipients or categories of recipients to whom your personal data has been or will be disclosed</li>
                        <li>the planned storage duration of your personal data or, if specific information in that regard is not possible, criteria for determining the storage period</li>
                        <li>the existence of any right to correct or delete your personal data or restrict or object to is further processing by us</li>
                        <li>right to lodge a complaint with a supervisory authority</li>
                        <li>all available information on the source(s) of the data, if the personal data has not been obtained from you directly</li>
                        <li>
                            <p>
                                the existence of automated decision-making processes, including profiling, as defined in Art. 22 para. 1 and 4 GDPR and meaningful information on the logic involved and the scope and intended effects of such processing for the data subject. You have the right to request information regarding whether your personal information will be transmitted to a non-EU country or an international organization. In this respect, you can request the appropriate guarantees in connection with the transmission in accordance with Art. 46 GDPR.
                            </p>
                        </li>
                    </ol>
                </li>
                ...
                <li>
                    ...
                    <ol>
                        <li>you dispute the accuracy of the personal data we have on file; its processing would then be restricted for as long as it takes us to verify its accuracy</li>
                        <li>the processing is unlawful and you do not wish to have the data deleted and instead wish its further use to be restricted</li>
                        <li>we no longer need the personal data for processing, but you need it to assert, exercise, or defend legal claims, or</li>
                        <li><p>you have objected to processing pursuant to Art. 21 para. 1 GDPR and it has not yet been established whether our legitimate reasons for continued processing of your data outweigh your right to object to the same</p></li>
                    </ol>
                    <p>
                    ...
                    <ul>
                        <li>
                            ...
                            <ol>
                                ...
                                <li>You withdraw the consent that was the basis of its processing per Art. 6 para. 1 lit. a or Art. 9 para. 2 lit. a GDPR and there is no other legal basis for its continued processing</li>
                                <li>You can submit an objection in accordance with Art. 21 para. 1 GDPR and there are no overriding legitimate grounds for its continued processing; or you submit an objection according to Art. 21 para. 2 GDPR.</li>
                                <li>Your personal data has been unlawfully processed.</li>
                                <li>Your personal data is required in order to comply with a legal obligation under Union or Member State law to which we are subject.</li>
                                <li><p>Your personal data has been collected in relation to services offered by information services pursuant to Art. 8 para. 1 GDPR.</p></li>
                            </ol>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ol>
                                ...
                                <li>for the performance of a legal obligation which makes such processing mandatory under the law of the Union or of the Member States to which we are subject or for the performance of a task in the public interest or in the exercise of official authority conferred upon us</li>
                                <li>for reasons of public interest in the field of public health in accordance with Art. 9 para. 2 lit. h and i, as well as Art. 9 para. 3 GDPR</li>
                                <li>for archival purposes in the public interest, scientific or historical research purposes or for statistical purposes in accordance with Art. 89 para. 1 GDPR, to the extent that the right referred to in (a) is likely to render impossible or seriously inhibit the ability to achieve said purposes; or</li>
                                <li><p>to assert, exercise, or defend legal claims.</p></li>
                            </ol>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ol>
                        <li>the processing is based on consent pursuant to Art. 6 para. 1 lit. a GDPR or Art. 9 para. 2 lit. a GDPR or on the basis of a contract in accordance with Art. 6 para. 1 lit. b GDPR and</li>
                        <li><p>the processing takes place with the help of automated procedures.</p></li>
                    </ol>
                    <p>
                ...
                <li>
                    ...
                    <ol>
                        <li>is necessary for us to establish or fulfill a contract with you</li>
                        <li>is authorized by EU or national law to which we are subject, provided said law also sets forth suitable measures for safeguarding your rights, and freedoms, and legitimate interests; or</li>
                        <li><p>is based on your explicit consent.</p></li>
                    </ol>
                    <p>
