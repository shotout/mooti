    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 c-footer-left">
                <a class="mr-3 f-inter" style="color: #fff;" href="{{url('/terms')}}">Terms of Use</a>
                <a class="f-inter" style="color: #fff;" href="{{url('/privacy')}}">Privacy Policy</a>
            </div>
            <div class="col-md-6 c-footer-right">
                ...
                <a class="c-hmobile" href="https://mooti.app" target="_blank" style="color: #fff;" rel="noopener noreferrer">
                | <span class="ml-2 f-inter">©2022 Mooti</span>
                </a>
            </div>

            <div class="col-md-6 text-center c-dmobile mt-1">
                <a href="https://mooti.app" target="_blank" style="color: #fff;" rel="noopener noreferrer">
